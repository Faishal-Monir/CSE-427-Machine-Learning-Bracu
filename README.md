...
- Local copies are in `CSE-427(Final Project)/train.csv` and `CSE-427(Final Project)/test.csv`.
- The notebook also includes Google Drive links for loading the same data directly.(You need to upload the file and make a share link from your google drive on your own. Make sure the link has viewer access only)

## How to Run
1) Open the notebook in Jupyter or Colab:
   - `CSE-427(Final Project)/CSE-427_Final project_Sec-1_Group-9 .ipynb`
...
- `CSE-427(Final Project)/` : Final project notebook, data, and research paper(Subject to @Copyright)
- `LAB-1` ... `LAB-6` : Course lab submissions
